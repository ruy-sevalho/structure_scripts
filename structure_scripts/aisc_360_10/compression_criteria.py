...
from structure_scripts.aisc_360_10.criteria import Criteria, SafetyFactor, AllowableStrengthDesign, CriteriaAdaptor
from structure_scripts.aisc_360_10.beams import BucklingParam, BeamAnalysis, BeamGlobalData
from structure_scripts.aisc_360_10.helpers import elastic_flexural_buckling_stress, _member_slenderness_limit, \
    critical_compression_stress_buckling_default, _nominal_compressive_strength
...
class FlexuralBucklingAdaptor(CriteriaAdaptor):
    ...
    def criteria(self) -> BucklingStrength:
        return BucklingStrength(
            ...
            member_slenderness_limit=self.beam_slenderness_limit,
            yield_stress=self.section.material.yield_stress
        )
